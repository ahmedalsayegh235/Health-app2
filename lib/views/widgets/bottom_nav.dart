    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            _buildNavItem(Icons.home, 'Home', 0, iconSize, iconPadding),
            _buildNavItem(Icons.timeline, 'Activity', 1, iconSize, iconPadding),
            _buildNavItem(Icons.calendar_today, 'Appointment', 2, iconSize, iconPadding),
            _buildNavItem(Icons.chat_bubble_outline, 'Chat', 3, iconSize, iconPadding),
